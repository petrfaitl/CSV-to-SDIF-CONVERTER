...
def EmitD0 (lastName, firstName, MMCode,
    ...
    "D0","2","", fullName[:28],MMCode,"","",dateOfBirth.strftime("%m%d%Y"),"",gender,"X", eventDistance, eventStrokeCode, 
...
def EmitD1 (lastName, firstName, regNo,
    ...
    "D1","2","", "  " + clubCode, "", fullName[:28], "", MMCode,"","",dateOfBirth.strftime("%m%d%Y"),"",gender,"")
    return d1line
```
